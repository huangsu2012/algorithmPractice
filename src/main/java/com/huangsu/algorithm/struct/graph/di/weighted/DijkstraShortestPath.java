 ...
 *
 * dijkstra算法查找最短路径，只对非负权重有向图有效
 */
public class DijkstraShortestPath extends AbstractEdgeWeightedDigraphPath {

  //索引为顶点，值为权重
  private final IndexMinPriorityQueue<Double> minPriorityQueue;

  protected DijkstraShortestPath(EdgeWeightedDigraph g, int s) {
    super(g, s, true);
